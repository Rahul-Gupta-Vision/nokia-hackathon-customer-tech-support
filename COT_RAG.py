...
# PDF_FILES = [f for f in ["userguide.pdf", "y1731.pdf", "8021ag-2007.pdf"]]
# MD_FILES  = [f for f in ["CFM_OAM.md", "cfm-debugging.md"]]
...
# # ------------------------------------------------- GLOBAL -------------------------------------------------
# retriever = None   # will be filled in lifespan
...
#     version="1.0.0",
#     lifespan=lifespan,          # <-- NEW: replaces @on_event
# )
...
#     retrieved = retriever.get_relevant_documents(question)[:k]
...
# # ------------------------------------------------- JUPYTER RUN -------------------------------------------------
# # **ONLY** execute the block below inside a notebook cell
# # (remove or comment it out when running the file as a normal script)

# """
# import nest_asyncio
# nest_asyncio.apply()
# import uvicorn
# from rag_with_cot_api import app
...
PDF_FILES = [BASE_DIR / f for f in ["userguide.pdf", "y1731.pdf", "8021ag-2007.pdf"]]
MD_FILES  = [BASE_DIR / f for f in ["CFM_OAM.md", "cfm-debugging.md"]]
